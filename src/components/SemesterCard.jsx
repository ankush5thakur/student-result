...
const SemesterCard = ({ semester }) => {
  return (
    <div className="flex flex-col w-full h-auto bg-slate-500 mx-auto mt-4 justify-center items-center rounded-lg shadow-lg">
      ...
      <div className="bg-slate-300 w-full p-4 flex flex-col rounded-b-lg">
        {semester.subject_results.map((subject, index) => (
          <div
            key={index}
            className="flex items-center border-b border-gray-400 py-2 last:border-b-0"
          >
